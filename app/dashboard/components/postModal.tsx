            ...
            >
                ...
                {post && (
                    <div className="p-6">
                        ...
                        <div className="mt-6 p-4 bg-neutral-950 rounded-lg space-y-4 border border-neutral-800">
                            ...
                            {post.stocks && post.stocks.map((stock, index) => (
                                <div key={index} className="mt-6 p-4 bg-neutral-900 rounded-xl border border-neutral-800 shadow-md">
